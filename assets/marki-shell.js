(function () {
  ...
  function installShell() {
    ...
    let currentHref = "";
    if (path === "/marki-a-z/") currentHref = "/marki-a-z/";
    else if (path === "/kategorie/" || path.indexOf("/kategorie/") === 0) currentHref = "/kategorie/";
    else if (path === "/o-serwisie/") currentHref = "/o-serwisie/";
    else if (path === "/kontakt-i-zrodla/") currentHref = "/kontakt-i-zrodla/";
